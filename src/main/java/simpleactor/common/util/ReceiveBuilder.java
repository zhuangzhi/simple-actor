...
public class ReceiveBuilder {
     ...
     */
    public static <P> UnitPFBuilder match(final Class<P> type, FI.UnitApply<P> apply) {
     ...
     * @return           a builder with the case statement added
     */
    public static <P> UnitPFBuilder match(final Class<P> type,
     ...
     * @return a builder with the case statement added
     */
    public static <P> UnitPFBuilder matchEquals(P object, FI.UnitApply<P> apply) {
     ...
     * @return a builder with the case statement added
     */
    public static <P> UnitPFBuilder matchEquals(P object,
                                                        FI.TypedPredicate<P> predicate,
                                                        FI.UnitApply<P> apply) {
     ...
     * @return           a builder with the case statement added
     */
    public static <P> UnitPFBuilder matchAny(FI.UnitApply<P> apply) {
